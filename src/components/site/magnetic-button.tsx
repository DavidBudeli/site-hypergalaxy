...
export function MagneticButton({
  ...
  return (
    <motion.a
      ...
      {...props}
    >
      <span className="absolute inset-0 translate-y-full bg-gradient-to-t from-cyan-200/20 to-transparent transition-transform duration-500 group-hover:translate-y-0" />
